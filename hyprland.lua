-- NOTE: some settings are better configured in a 
-- separate file, since they contain hardware- and
-- device-specific configuration. Following is an 
-- example of a single monitor configuration:
--
-- hl.monitor({
--     output   = "",
--     mode     = "2560x1440@240",
